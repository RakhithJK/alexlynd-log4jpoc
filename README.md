...
A Proof-Of-Concept vulnerable web application for the [Log4J vulnerability]() (CVE-2021-44228), based off [Kozmer's Log4Shell POC]().  This simple fork allows a web browser's User Agent to be logged when the site is visited.<br><br>
